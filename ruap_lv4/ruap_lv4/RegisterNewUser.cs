...
namespace SeleniumTests
{
    ...
    public class RegisterNewUser
    {
        ...
        public void TheRegisterNewUserTest()
        {
            ...
            driver.FindElement(By.Id("LastName")).SendKeys("Cica");
            driver.FindElement(By.Id("Email")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("filip.cica13@gmail.com");
            driver.FindElement(By.Id("Email")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("filip.cica113@gmail.com");
